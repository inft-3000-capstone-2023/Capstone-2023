...
<div class="container">
    ...
    <div class="col-md-8">
        ...
        />
        <div>
            <link href="{{ URL::asset('css/customer_register.css') }}" rel="stylesheet" />
            <div class="register-container">
                <div class="register-section">
                    ...
                    <form class="register-form" method="POST" action="{{ route('customer.register.store', $client) }}">
                        @csrf
                        ...
                        <div class="form-check" id="marketing_checkbox">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" name="marketing" checked>
                            <label class="form-check-label" for="flexCheckChecked">
                                Sign up for promotional and marketing material from {{ $client->company_name }}
                            </label>
                        </div>

            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{route('client.client_organizer', $client)}}">Organizer Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('client.client_team', $client)}}">Team Management</a>
                        </li>
                    </ul>
                    </div>
                    @if (session('status'))
